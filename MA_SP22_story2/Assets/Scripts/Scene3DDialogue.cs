...
public void talking(){         // main story function. Players hit next to progress to next int
        ...
        if (primeInt == 1){
            ...
            DialogueDisplay.SetActive(true);
                Char1name.text = "";
                Char1speech.text = "Time to use this distraction to my advantage";
                Char2name.text = "";
                Char2speech.text = "";
        }
       else if (primeInt ==3){
            ...
            Char1name.text = "";
                 Char1speech.text = "";
                 Char2name.text = "Man";
                 Char2speech.text = "I'm going to have to ask you to--";
         }
         else if (primeInt ==9){
                  Char1name.text = "";
            ...
            ArtChar2Stern.SetActive(false);
            Char1name.text = "";
                Char1speech.text = "He gives you a glance before running to see what the problem is.";
                Char2name.text = "";
                Char2speech.text = "";
